    ...
    <div className='project-main-div'>
        ...
        <div className='project-left-column'>
            <div className='project-text'>
                <h3 className='project-mission-header white-text-color'>OUR PROJECT</h3>
                <h2 className='project-mission-title white-text-color slogan'>Transforming Education Together.</h2>
        ...
        <div className='project-right-column'>
            <img src={project_image} className='project-image' alt="Project representation" />
